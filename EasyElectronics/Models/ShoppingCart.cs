...
namespace MVCLogin.Models
{
    ...
    {
        EasyElecDBEntities storeDB = new EasyElecDBEntities();
        ...
        public void AddToCart(tblProduct item)
        {
        ...
        public decimal GetTotal()
        {
            ...
            decimal? total = (from cartItems in storeDB.tblCarts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.tblProduct.UnitPrice).Sum();
        ...
        public int CreateOrder(tblOrder order)
        {
            ...
            foreach (var item in cartItems)
            {
                var orderDetail = new tblOrderDetail
                {
                    ...
                    UnitPrice = item.tblProduct.UnitPrice,
                    Quantity = item.Count
                };
                // Set the order total of the shopping cart 
                orderTotal += Convert.ToDecimal(item.Count * (item.tblProduct.UnitPrice));
        ...
        {
            var shoppingCart = storeDB.tblCarts.Where(
                c => c.CartId == ShoppingCartId);
