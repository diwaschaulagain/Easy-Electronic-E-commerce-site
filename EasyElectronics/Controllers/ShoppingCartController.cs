...
namespace MVCLogin.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult AddToCart(int id)
        {
            ...
            var addedItem = storeDB.tblProducts
        ...
        public ActionResult RemoveFromCart(int id)
        {
            ...
            // Get the name of the album to display confirmation 
            string albumName = storeDB.tblCarts.Single(item => item.RecordId == id).tblProduct.ProductName;
        ...
        public ActionResult AddressAndPayment(OrderViewModel ovm)
        {
            ...
            foreach (var item in lst)
            {
                ...
                tbord.UnitPrice = item.tblProduct.UnitPrice;
